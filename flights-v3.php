...
@media(max-width:1100px){.mt-search-row{grid-template-columns:1fr 1fr;gap:8px}.mt-field{border:1px solid #edf1f6!important;border-radius:10px;padding:11px;min-width:0}.mt-field input,.mt-field .form-control{width:100%;max-width:100%;box-sizing:border-box}.mt-swap{display:none}.mt-search-button{min-height:52px;margin:0}.mt-trust{grid-template-columns:1fr 1fr;gap:10px}.mt-trust div{border:0}.mt-pax-popup{left:auto;right:0;max-width:min(340px,90vw)}}
@media(max-width:720px){.mt-flight-page{overflow-x:hidden}.mt-flight-wrap{width:calc(100% - 22px);max-width:100%;margin:auto}.mt-flight-head{align-items:flex-start;gap:10px;flex-direction:column}.mt-flight-head h1{font-size:24px}.mt-engine-badge{align-self:flex-start}.mt-search-card{width:100%;box-sizing:border-box;overflow:visible}.mt-search-row{display:flex;flex-direction:column;gap:8px;padding:10px}.mt-field{width:100%;box-sizing:border-box;border:1px solid #e5edf5!important;border-radius:10px;padding:11px}.mt-field input,.flatpickr-input,.form-control{width:100%!important;max-width:100%!important;box-sizing:border-box!important}.mt-search-button{width:100%;margin:2px 0 0;height:52px}.mt-trust{grid-template-columns:1fr;gap:7px}.mt-tabs{padding-left:12px}.mt-pax-popup{position:fixed;left:12px!important;right:12px!important;top:auto!important;bottom:12px;width:auto!important;max-width:none!important;max-height:70vh;overflow:auto}.mt-airport-list{position:fixed;left:12px;right:12px;top:145px;max-height:55vh}}
</style>
