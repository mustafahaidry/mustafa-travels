...
<div class="rv-wrap">
    ...
    <div class="rv-head">
        ...
        <?php if(!$error): ?>
            <a class="rv-preview" target="_blank" href="flight-booking-preview.php?offer_id=<?=urlencode($offerId)?>">▣ PDF Booking Preview</a>
        <?php endif; ?>
    </div>
    ...
    <div class="rv-grid">
        ...
        <div>
            ...
            <div class="rv-card">
                ...
                <p>The selected baggage is now saved with this checkout. The next phase will use these service IDs when creating the Duffel order.</p>
            </div>
        </div>
        ...
        <aside class="rv-summary">
            ...
            <div class="rv-actions">
                <a class="rv-btn rv-pdf" target="_blank" href="flight-booking-preview.php?offer_id=<?=urlencode($offerId)?>">PDF Booking Preview</a>
                <a class="rv-btn rv-primary" href="#" onclick="alert('Next phase: Hold / Payment / Create Duffel Order');return false;">Continue to payment / hold</a>
