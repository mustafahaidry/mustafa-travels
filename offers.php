<?php require_once __DIR__.'/partials.php'; $offers=sb_select('offers','select=*&active=eq.true&order=featured.desc,id.desc'); site_header('Special Offers'); ?>
...
<article class="offer-card"><div class="offer-media" <?php if($o['image_url']): ?>style="background-image:url('<?=h($o['image_url'])?>')"<?php endif; ?>><span class="offer-badge"><?=h($o['badge'] ?: 'Special Offer')?></span></div>
