...
<div class="tools">
    <button class="back" onclick="location.href='flight-review.php?offer_id=<?=urlencode($offerId)?>'">← Back to Booking</button>
    <button class="back" onclick="location.href='flight-review.php?offer_id=<?=urlencode($offerId)?>#baggage-form'">+ Extra Baggage</button>
    <button class="back" onclick="location.href='flight-review.php?offer_id=<?=urlencode($offerId)?>#payment-section'">Payment / Hold</button>
